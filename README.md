...
5. **Three exception reports** - Leads missing required fields, leads with no activity in 30+ days, and possible duplicates that were flagged but not blocked. See [05-report-missing-fields.png](screenshots/05-report-missing-fields.jpg), [06-report-stale-leads.png](screenshots/06-report-stale-leads.jpg), [07-report-possible-duplicates.png](screenshots/07-report-possible-duplicates.jpg).
